...
#ifdef DEV_MODE
const char *ws_server = "192.168.1.95";
const uint16_t ws_port = 8000;
const char *ws_path = "/";
// Backend server details 
const char *backend_server = "192.168.1.95";
const uint16_t backend_port = 3000;

#else
// PROD
const char *ws_server = "pipecat-test-production.up.railway.app";
...
// pipecat-test-production.up.railway.app root CA cert
const char *CA_cert = R"EOF(
-----BEGIN CERTIFICATE-----
MIIFazCCA1OgAwIBAgIRAIIQz7DSQONZRGPgu2OCiwAwDQYJKoZIhvcNAQELBQAw
TzELMAkGA1UEBhMCVVMxKTAnBgNVBAoTIEludGVybmV0IFNlY3VyaXR5IFJlc2Vh
